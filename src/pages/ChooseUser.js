...
const ChooseUser = ({ visitor }) => {
  ...
  const password = "rahulgupta630738@gmail.com";
  ...
  const navigateHandler = (user) => {
    if (user === "Admin") {
      if (visitor === "guest") {
        const email = "rahulgupta630738@gmail.com";
      ...
      if (visitor === "guest") {
        const email = "abhimanyu@gmail.com";
        const fields = { email, password: "abhimanyu@gmail.com" };
        setLoader(true);
        dispatch(loginUser(fields, user));
      } else {
